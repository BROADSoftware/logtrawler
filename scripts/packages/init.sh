...
# description: Starts and stops a single logtrawler instance on this system 
#
...
# Default-Stop: 0 1 6
# Short-Description: This service manages the logtrawler daemon
# Description: logtrawler allow log collection from log files.
### END INIT INFO


prog=logtrawler
jar=/opt/logtrawler/logtrawler.jar
confjson=/etc/logtrawler/config.json
